...
imageID COREMOD_MEMORY_streamPaste(const char *IDstream0_name,
                                   ...
                                   const char *IDstreamout_name, long semtrig0,
                                   long semtrig1, int master);
...
errno_t stream_paste_addCLIcmd() {
  RegisterCLIcommand(
      "streampaste", __FILE__, COREMOD_MEMORY_streamPaste__cli,
      "paste two 2D image streams of same size",
      "<in stream 0> <in stream 1> <out stream> <sem trigger0> <sem trigger1> "
      "<master>",
      "streampaste stream0 stream1 outstream 3 3 0",
      "long COREMOD_MEMORY_streamPaste(const char *IDstream0_name, const char "
      "*IDstream1_name, const char *IDstreamout_name, long semtrig0, long "
      "semtrig1, int master)");
