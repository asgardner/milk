    ...
    if(kwnindex != -1)  // if FPS has been found
    {
        ...
        if((cmdFOUND == 0) && (strcmp(FPScommand, "tmuxstart") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("TMUXSTART",
                                         "Init tmux session %d %s",
                                         fpsindex,
        ...
        if((cmdFOUND == 0) && (strcmp(FPScommand, "tmuxstop") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("TMUXSTOP",
                                         "Init tmux session %d %s",
                                         fpsindex,
                                         fps[fpsindex].md->name);
                cmdOK = 1;
        ...
        if((cmdFOUND == 0) && (strcmp(FPScommand, "confstart") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("CONFSTART",
                                         "start CONF process %d %s",
                                         fpsindex,
                                         fps[fpsindex].md->name);
                cmdOK = 1;
            }
        ...
        if((cmdFOUND == 0) && (strcmp(FPScommand, "confstop") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("CONFSTOP",
                                         "stop CONF process %d %s",
                                         fpsindex,
                                         fps[fpsindex].md->name);
                cmdOK = 1;
            }
        ...
        if((cmdFOUND == 0) && (strcmp(FPScommand, "confupdate") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("CONFUPDATE",
                                         "update CONF process %d %s",
                                         fpsindex,
                                         fps[fpsindex].md->name);
                cmdOK = 1;
            }
        ...
        if((cmdFOUND == 0) && (strcmp(FPScommand, "runstart") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("RUNSTART",
                                         "start RUN process %d %s",
                                         fpsindex,
                                         fps[fpsindex].md->name);
                cmdOK = 1;
            }
        ...
        if((cmdFOUND == 0) && (strcmp(FPScommand, "runwait") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("RUNWAIT",
                                         "waited %d us on FPS %d %s",
                                         dt * timercnt,
                                         fpsindex,
                                         fps[fpsindex].md->name);
                cmdOK = 1;
        ...
        if((cmdFOUND == 0) && (strcmp(FPScommand, "runstop") == 0))
        {
            ...
            else
            {
                ...
                functionparameter_outlog("RUNSTOP",
                                         "stop RUN process %d %s",
                                         fpsindex,
                                         fps[fpsindex].md->name);
                cmdOK = 1;
            }
        ...
        if((cmdFOUND == 0) && (strcmp(FPScommand, "fpsrm") == 0))
        {
            ...
            else
            {
                ...
                DEBUG_TRACEPOINT("Posting to fps log %s",
                                 fps[fpsindex].md->name);
                functionparameter_outlog("FPSRM",
                                         "FPS remove %d %s",
                                         fpsindex,
                                         fps[fpsindex].md->name);
                cmdOK = 1;
