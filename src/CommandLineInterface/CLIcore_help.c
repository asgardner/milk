...
errno_t printInfo() {
  ...
  printf(
      "   version                     offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
  ...
  printf(
      "   name                        offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   naxis                       offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   size                        offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   nelement                    offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   datatype                    offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   imagetype                   offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   creationtime                offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   lastaccesstime              offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   atime                       offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   writetime                   offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  offsetval = offsetof(IMAGE_METADATA, location);
  printf(
      "   shared                      offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   location                    offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   status                      offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   flag                        offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  offsetval = offsetof(IMAGE_METADATA, sem);
  printf(
      "   logflag                     offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   sem                         offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   cnt0                        offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   cnt1                        offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   cnt2                        offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
  ...
  printf(
      "   write                       offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
  ...
  printf(
      "   NBkw                        offset = %4zu bit  = %4zu byte     [%4zu "
      "byte]\n",
      8 * offsetval0, offsetval0, offsetval - offsetval0);
 ...
 *
 */
int CLIhelp_make_argstring(CLICMDARGDEF fpscliarg[], int nbarg,
                           char *outargstring) {
  char tmpstr[1000];
 ...
 *
 */
int CLIhelp_make_cmdexamplestring(CLICMDARGDEF fpscliarg[], int nbarg,
                                  char *shortname, char *outcmdexstring) {
  char tmpstr[1000];
...
static int checkFlag64(uint64_t flags, uint64_t testflag,
      ...
      for (int argi = 0; argi < data.cmd[cmdi].nbarg; argi++) {
        ...
        if (!(data.cmd[cmdi].argdata[argi].flag & CLICMDARG_FLAG_NOCLI)) {
          ...
          switch (data.cmd[cmdi].argdata[argi].type) {
            case CLIARG_FLOAT:
              slen = snprintf(valuestring, STRINGMAXLEN_CLICMDARG, "[FLOAT] %f",
            ...
            case CLIARG_LONG:
              slen =
                  snprintf(valuestring, STRINGMAXLEN_CLICMDARG, "[LONG]  %ld",
            ...
            case CLIARG_STR_NOT_IMG:
              slen = snprintf(valuestring, STRINGMAXLEN_CLICMDARG, "[STRnI] %s",
            ...
            case CLIARG_IMG:
              slen = snprintf(valuestring, STRINGMAXLEN_CLICMDARG, "[IMG]   %s",
                              data.cmd[cmdi].argdata[argi].val.s);
              if (slen < 1) {
                PRINT_ERROR("snprintf wrote <1 char");
                abort();
            ...
            case CLIARG_STR:
              slen = snprintf(valuestring, STRINGMAXLEN_CLICMDARG, "[STR]   %s",
                              data.cmd[cmdi].argdata[argi].val.s);
              if (slen < 1) {
                PRINT_ERROR("snprintf wrote <1 char");
                abort();
          ...
          printf(COLORARGCLI " %-16s" COLORRESET " %-24s %s\n",
                 data.cmd[cmdi].argdata[argi].fpstag, valuestring,
  ...
  for (unsigned int cmdi = 0; cmdi < data.NBcmd; cmdi++) {
    ...
    if (strstr(data.cmd[cmdi].info, searchstring) != NULL) {
      ...
      printf("%c[%d;%dm%s%c[%dm in %s [%s]\n\t%c[%d;%dm%s%c[%dm\n", (char)27, 1,
             colorcodecmd, data.cmd[cmdi].key, (char)27, 0,
             data.cmd[cmdi].module,
             data.module[data.cmd[cmdi].moduleindex].shortname, (char)27, 1,
             colorcodeinfo, data.cmd[cmdi].info, (char)27, 0);
    }
    ...
    if (matchsubstring == 0) {
      ...
      if (!reti) {
        ...
        printf("%c[%d;%dm%s%c[%dm in %s [%s]\n\t%c[%d;%dm%s%c[%dm\n", (char)27,
               1, colorcodecmd, data.cmd[cmdi].key, (char)27, 0,
               data.cmd[cmdi].module,
               data.module[data.cmd[cmdi].moduleindex].shortname, (char)27, 1,
               colorcodeinfo, data.cmd[cmdi].info, (char)27, 0);
...
errno_t help_module() {
  if (data.cmdargtoken[1].type == 3) {
    ...
    printf("%2s  %10s %32s %10s %7s    %20s %s\n", "#", "shortname", "Name",
           "Package", "Version", "last compiled", "description");
    printf(
        "----------------------------------------------------------------------"
        "----------------------------------------\n");
    for (i = 0; i < data.NBmodule; i++) {
      printf(
          "%2ld %10s \033[1m%32s\033[0m %10s %2d.%02d.%02d    %11s %8s  %s\n",
          i, data.module[i].shortname, data.module[i].name,
          data.module[i].package, data.module[i].versionmajor,
          data.module[i].versionminor, data.module[i].versionpatch,
