  ...
  *taskstatus |= FPSTASK_STATUS_RECEIVED;
  ...
  if ((cmdFOUND == 0) && (strcmp(FPScommand, "logsymlink") == 0)) {
    ...
    if (nbword != 2) {
      ...
      functionparameter_outlog("INFO", "CREATE SYM LINK %s <- %s", FPSarg0,
                               logfname);
  ...
  if ((cmdFOUND == 0) && (strcmp(FPScommand, "queueprio") == 0)) {
    ...
    if (nbword != 3) {
      ...
      if ((queue >= 0) && (queue < NB_FPSCTRL_TASKQUEUE_MAX)) {
        ...
        functionparameter_outlog("INFO", "%s", "QUEUE %d PRIO = %d", queue,
                                 prio);
      }
    }
  }
  ...
  if (cmdFOUND == 0) {
    ...
    //            nbword, cmdOK, kwnindex); functionparameter_outlog("INFO",
    //            "%s", msgstring);
    ...
    if (kwnindex != -1) {
      ...
      functionparameter_outlog("ERROR", "FPS ENTRY NOT FOUND : %-40s",
                               FPSentryname);
      cmdOK = 0;
    }
  }
  ...
  if (kwnindex != -1)  // if FPS has been found
  {
    ...
    if ((cmdFOUND == 0) && (strcmp(FPScommand, "confstart") == 0)) {
      cmdFOUND = 1;
      if (nbword != 2) {
        functionparameter_outlog("ERROR", "%s",
      ...
      if (nbword != 2) {
        ...
        while (looptry == 1) {
          ...
          functionparameter_outlog(
              "CONFWUPDATE", "[%d] waited %d us on FPS %d %s. conferrcnt = %d",
              looptrycnt, dt * timercnt, fpsindex, fps[fpsindex].md->name,
    ...
    if ((cmdFOUND == 0) && (strcmp(FPScommand, "runstop") == 0)) {
      ...
      if (nbword != 2) {
        ...
        functionparameter_outlog("RUNSTOP", "stop RUN process %d %s", fpsindex,
                                 fps[fpsindex].md->name);
        cmdOK = 1;
      }
    }
    ...
    if ((cmdFOUND == 0) && (strcmp(FPScommand, "setval") == 0)) {
      ...
      if (nbword != 3) {
        ...
        switch (fps[fpsindex].parray[pindex].type) {
          case FPTYPE_INT64:
            if (functionparameter_SetParamValue_INT64(
                    &fps[fpsindex], FPSentryname, atol(FPScmdarg1)) ==
                EXIT_SUCCESS) {
              updated = 1;
            }
          ...
          case FPTYPE_FLOAT64:
            if (functionparameter_SetParamValue_FLOAT64(
                    &fps[fpsindex], FPSentryname, atof(FPScmdarg1)) ==
                EXIT_SUCCESS) {
              updated = 1;
            }
          ...
          case FPTYPE_FILENAME:
            if (functionparameter_SetParamValue_STRING(
                    &fps[fpsindex], FPSentryname, FPScmdarg1) == EXIT_SUCCESS) {
              updated = 1;
            }
          ...
          case FPTYPE_ONOFF:
            if (strncmp(FPScmdarg1, "ON", 2) == 0) {
              if (functionparameter_SetParamValue_ONOFF(
                      &fps[fpsindex], FPSentryname, 1) == EXIT_SUCCESS) {
                updated = 1;
              }
            ...
            if (strncmp(FPScmdarg1, "OFF", 3) == 0) {
              if (functionparameter_SetParamValue_ONOFF(
                      &fps[fpsindex], FPSentryname, 0) == EXIT_SUCCESS) {
                updated = 1;
              }
        ...
        if (updated == 1) {
          cmdOK = 1;
          functionparameter_WriteParameterToDisk(&fps[fpsindex], pindex,
                                                 "setval", "InputCommandFile");
        ...
        */
        ...
        if (cmdOK == 1) {
          ...
          if (strcmp(FPScommand, "fwrval") == 0) {
            ...
            SNPRINTF_CHECK(msgstring1, STRINGMAXLEN_FPS_LOGMSG,
                           "WROTE to file %s", FPScmdarg1);
