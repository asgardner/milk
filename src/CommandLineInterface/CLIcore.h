...
#define INIT_MODULE_LIB(modname)                                      \
  ...
  void __attribute__((constructor)) libinit_##modname() {             \
    ...
    {                                                                 \
      ...
      RegisterModule(__FILE__, PROJECT_NAME, MODULE_DESCRIPTION,      \
...
typedef struct {
  ...
  char shortname[STRINGMAXLEN_MODULE_SHORTNAME];  // short name. If non-empty,
                                                  // access functions as
  ...
  char package[STRINGMAXLEN_MODULE_PACKAGENAME];  // package to which module
                                                  // belongs
...
typedef struct {
  ...
  char shmsemdirname[STRINGMAXLEN_DIRNAME];  // same ad above with .s instead of
                                             // /s
  ...
  */
  ...
  // conf, run, ctrl
  char FPS_PROCESS_TYPE[STRINGMAXLEN_FPSPROCESSTYPE];  // included in log file
                                                       // name
