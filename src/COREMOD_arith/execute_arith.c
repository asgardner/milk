...
imageID arith_make_slopexy(const char *ID_name, long l1, long l2, double sx,
                           double sy) {
  DEBUG_TRACE_FSTART();
      ...
      for (int i = 0; i < nbword - 2; i++)
        if ((word_type[i] == ARITHTOKENTYPE_OPENPAR) &&
          ...
          memmove(word[i], word[i + 1],
                  strlen(word[i + 1]));  // strcpy(word[i], word[i + 1]);
          word_type[i] = word_type[i + 1];
          for (j = i + 1; j < nbword - 2; j++) {
            memmove(word[j], word[j + 2],
                    strlen(word[j + 2]));  // strcpy(word[j], word[j + 2]);
      ...
      for (int i = 0; i < nbword - 3; i++)
        if ((word_type[i] == ARITHTOKENTYPE_OPENPAR) &&
          ...
          data.variable[variable_ID(word[i + 2])].value.f =
              -data.variable[variable_ID(word[i + 2])].value.f;
          memmove(word[i], word[i + 2],
                  strlen(word[i + 2]));  // strcpy(word[i], word[i + 2]);
          word_type[i] = word_type[i + 2];
          for (j = i + 2; j < nbword - 3; j++) {
            memmove(word[j], word[j + 3],
                    strlen(word[j + 3]));  // strcpy(word[j], word[j + 3]);
      ...
      */
      if (word_type[highest_priority_index] == ARITHTOKENTYPE_OPERAND) {
        ...
        if (strcmp(word[highest_priority_index], "+") == 0) {
          if ((word_type[highest_priority_index - 1] ==
              ...
              (word_type[highest_priority_index + 1] ==
               ARITHTOKENTYPE_VARIABLE)) {
            tmp_prec =
                data.variable[variable_ID(word[highest_priority_index - 1])]
                    .value.f +
                data.variable[variable_ID(word[highest_priority_index + 1])]
                    .value.f;
          ...
          if ((word_type[highest_priority_index - 1] ==
            ...
            arith_image_cstadd(
                ...
                (double)data
                    .variable[variable_ID(word[highest_priority_index - 1])]
                    .value.f,
                name);
            tmp_name_index++;
          ...
          if ((word_type[highest_priority_index - 1] == ARITHTOKENTYPE_IMAGE) &&
            ...
            arith_image_add(word[highest_priority_index - 1],
                            word[highest_priority_index + 1], name);
            tmp_name_index++;
            type = ARITHTOKENTYPE_IMAGE;
          }
        }
        ...
        if (strcmp(word[highest_priority_index], "-") == 0) {
          ...
          if ((word_type[highest_priority_index - 1] ==
               ARITHTOKENTYPE_VARIABLE) &&
              (word_type[highest_priority_index + 1] == ARITHTOKENTYPE_IMAGE)) {
            CREATE_IMAGENAME(name1, "_tmp1%d_%d", tmp_name_index,
                             (int)getpid());
            arith_image_cstsub(
                word[highest_priority_index + 1],
                (double)data
        ...
        if (strcmp(word[highest_priority_index], "^") == 0) {
          if ((word_type[highest_priority_index - 1] == 2) &&
              (word_type[highest_priority_index + 1] == 2)) {
            if (data.variable[variable_ID(word[highest_priority_index + 1])]
                    .value.f < 0) {
              tmp_prec = pow(
                  data.variable[variable_ID(word[highest_priority_index - 1])]
                      .value.f,
      ...
      if (word_type[highest_priority_index] == 8) {
        ...
        if (strcmp(word[highest_priority_index], "cos") == 0) {
          if (word_type[highest_priority_index + 1] == 2) {
            tmp_prec =
                cos(data.variable[variable_ID(word[highest_priority_index + 1])]
                        .value.f);
            create_variable_ID(name, tmp_prec);
            tmp_name_index++;
            type = 2;
        ...
        if (strcmp(word[highest_priority_index], "exp") == 0) {
          if (word_type[highest_priority_index + 1] == 2) {
            tmp_prec =
                exp(data.variable[variable_ID(word[highest_priority_index + 1])]
                        .value.f);
            create_variable_ID(name, tmp_prec);
            tmp_name_index++;
            type = 2;
        ...
        if (strcmp(word[highest_priority_index], "ln") == 0) {
          if (word_type[highest_priority_index + 1] == 2) {
            tmp_prec =
                log(data.variable[variable_ID(word[highest_priority_index + 1])]
                        .value.f);
            create_variable_ID(name, tmp_prec);
            tmp_name_index++;
            type = 2;
        ...
        if (strcmp(word[highest_priority_index], "sin") == 0) {
          if (word_type[highest_priority_index + 1] == 2) {
            tmp_prec =
                sin(data.variable[variable_ID(word[highest_priority_index + 1])]
                        .value.f);
            create_variable_ID(name, tmp_prec);
            tmp_name_index++;
            type = 2;
        ...
        if (strcmp(word[highest_priority_index], "tan") == 0) {
          if (word_type[highest_priority_index + 1] == 2) {
            tmp_prec =
                tan(data.variable[variable_ID(word[highest_priority_index + 1])]
                        .value.f);
            create_variable_ID(name, tmp_prec);
            tmp_name_index++;
            type = 2;
        ...
        for (j = highest_priority_index + 1; j < nbword - 1; j++) {
          memmove(word[j], word[j + 1],
                  strlen(word[j + 1]));  // strcpy(word[j], word[j + 1]);
      ...
      if (word_type[highest_priority_index] == 11) {
        ...
        if (strcmp(word[highest_priority_index], "fmod") == 0) {
          if ((word_type[highest_priority_index + 2] == 2) &&
            ...
            tmp_prec = fmod(
                data.variable[variable_ID(word[highest_priority_index + 2])]
                    .value.f,
                data.variable[variable_ID(word[highest_priority_index + 4])]
                    .value.f);
            create_variable_ID(name, tmp_prec);
            tmp_name_index++;
            type = 2;
          ...
          if ((word_type[highest_priority_index + 2] == ARITHTOKENTYPE_IMAGE) &&
            ...
            arith_image_cstfmod(
                ...
                (double)data
                    .variable[variable_ID(word[highest_priority_index + 4])]
                    .value.f,
                name);
            tmp_name_index++;
            type = ARITHTOKENTYPE_IMAGE;
          ...
          if ((word_type[highest_priority_index + 2] == 10) &&
            ...
            arith_image_fmod(word[highest_priority_index + 2],
                             word[highest_priority_index + 4], name);
            tmp_name_index++;
            type = ARITHTOKENTYPE_IMAGE;
          }
        }
        ...
        if (strcmp(word[highest_priority_index], "min") == 0) {
          if ((word_type[highest_priority_index + 2] == 2) &&
              (word_type[highest_priority_index + 4] == 2)) {
            if (data.variable[variable_ID(word[highest_priority_index + 2])]
                    .value.f <
                data.variable[variable_ID(word[highest_priority_index + 4])]
                    .value.f) {
              tmp_prec =
          ...
          if ((word_type[highest_priority_index + 2] == 2) &&
            ...
            arith_image_cstminv(
                ...
                (double)data
                    .variable[variable_ID(word[highest_priority_index + 2])]
                    .value.f,
                name);
            tmp_name_index++;
            type = ARITHTOKENTYPE_IMAGE;
        ...
        if (strcmp(word[highest_priority_index], "perc") == 0) {
          ...
          if ((word_type[highest_priority_index + 2] != ARITHTOKENTYPE_IMAGE) ||
            ...
            //		  printf("Running percentile args = %s
          ...
          if ((word_type[highest_priority_index + 2] == ARITHTOKENTYPE_IMAGE) &&
            ...
            arith_image_trunc(
                ...
                (double)data
                    ...
                    .value.f,
                (double)data
                    .variable[variable_ID(word[highest_priority_index + 6])]
                    .value.f,
                name);
            type = ARITHTOKENTYPE_IMAGE;
          } else {
        ...
        strcpy(word[highest_priority_index], name);
        word_type[highest_priority_index] = type;
        for (j = highest_priority_index + 1; j < nbword - (nbvarinput * 2 + 1);
             j++) {
          memmove(
              word[j], word[j + (nbvarinput * 2 + 1)],
              strlen(
                  word[j + (nbvarinput * 2 + 1)]));  // strcpy(word[j], word[j +
                                                     // (nbvarinput * 2 + 1)]);
